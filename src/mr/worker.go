...
func Worker(mapf func(string, string) []KeyValue,
	...
	for {
		...
		if reply.ReduceTask != nil {
			...
			err := doReduce(reply.ReduceTask, reducef)
			ackReq := &TaskStateRequest{
...
func doMap(mapTask *MapTask, mapf func(string, string) []KeyValue) error {
...
func doReduce(reduceTask *ReduceTask, reducef func(string, []string) string) error {
